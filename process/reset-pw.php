...
require '../process/constants/uniques.php';
   ...
   $myfname = $row['first_name'];
    ...
    $stmt = $conn->prepare("INSERT INTO tokens (email, token) VALUES (:email, :token)");
    $stmt->bindParam(':email', $opt);
	$stmt->bindParam(':token', $token);
    $stmt->execute();	

	$message = "Hello!! <b>$full_name</b>, <br>Click <a href='$actual_link'>HERE</a> to reset your <b>ClearWayJobs</b> password.";   
    ...
    $mail->setFrom($smtp_user, 'clearwayjobs@no-reply');
