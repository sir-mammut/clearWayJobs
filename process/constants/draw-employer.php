<form name="frm" action="process/create-account.php" method="POST" autocomplete="off">
...
<input class="form-control" placeholder="Eg: Computer Software etc..." name="type" required type="text"> 
</div>
