...
$stmt = $conn->prepare("SELECT * FROM experience WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
$stmt = $conn->prepare("SELECT * FROM training WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
$stmt = $conn->prepare("SELECT * FROM language WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
$stmt = $conn->prepare("SELECT * FROM professional_qualification WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
$stmt = $conn->prepare("SELECT * FROM academic_qualification WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
...
$stmt = $conn->prepare("SELECT * FROM referees WHERE member_no = '$myid'");
$stmt->execute();
$result = $stmt->fetchAll();
