...
$stmt = $conn->prepare("UPDATE experience SET title=:title, institution=:institution, supervisor = :supervisor, supervisor_phone = :telphone, start_date =  :startdate, end_date = :enddate WHERE id=:expid AND member_no = '$myid'");
