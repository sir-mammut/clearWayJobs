...
<body class="not-transparent-header">
   ...
   ?>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM professional_qualification WHERE member_no = '$myid' ORDER BY id LIMIT $page1,5");
                                    $stmt->execute();
	...
	<div class="col-sm-12 col-md-2">
									...
									<form action="process/update-professional-qualification.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                $stmt = $conn->prepare("SELECT * FROM professional_qualification WHERE member_no = '$myid' ORDER BY id");
                                $stmt->execute();
                                $result = $stmt->fetchAll();
								...
								?>
				                    ...
				                    <div class="modal-body">
									<form action="process/add-professional-qualification.php" method="POST" autocomplete="off" enctype="multipart/form-data">
					                <div class="row gap-20">
									<div class="col-sm-12 col-md-12">
